...
M.MODELO_CODIGO, null, null, NO_HAY_BACKUP.fx_codigo_tiempo(COMPRA_FECHA) AS FECHA
...
M.MODELO_TIPO_MOTOR_CODIGO, M.MODELO_CAJA_COD, M.MODELO_TRANSMISION_COD, AUTO_TIPO_COD, NO_HAY_BACKUP.fx_codigo_potencia(M.MODELO_POTENCIA),
M.MODELO_CODIGO, null, null, NO_HAY_BACKUP.fx_codigo_tiempo(FACTURA_FECHA) AS FECHA
