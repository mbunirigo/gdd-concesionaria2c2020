...
CREATE TABLE [NO_HAY_BACKUP].[AUTO] (
  ...
  [AUTO_MODELO_CODIGO] decimal(18,0) NOT NULL REFERENCES [NO_HAY_BACKUP].AUTO_MODELO,
...
SELECT DISTINCT AUTO_NRO_MOTOR, AUTO_NRO_CHASIS, AUTO_PATENTE, AUTO_CANT_KMS, AUTO_FECHA_ALTA, TIPO_AUTO_CODIGO, MODELO_CODIGO FROM gd_esquema.Maestra
WHERE AUTO_NRO_MOTOR IS NOT NULL AND AUTO_NRO_CHASIS IS NOT NULL AND TIPO_AUTO_CODIGO IS NOT NULL AND MODELO_CODIGO IS NOT NULL
